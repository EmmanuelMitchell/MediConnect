...
export default function Navbar() {
  ...
  return (
    <header className="bg-gray-900 border-b-2">
      <nav
        aria-label="Global"
      ...
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="s text-white">Mediconnect</span>
            {/* Logo */}
          </a>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="#"
            className="text-sm font-semibold leading-6 text-gray-900 bg-white py-1 px-3 rounded "
          >
      ...
      >
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            {/* <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only text-red-500">Your Company</span>
              <img
                alt=""
